// Adapted from Decimen Optical Transfer v0.3.0 (MIT).
...
export class LTEncoder {
  ...
  encode(seq) {
    const idx = frameIndices(this.k, this.cdf, this.sessionId, seq >>> 0)
...
export class LTDecoder {
  ...
  addFrame(seq, block) {
    ...
    for (const b of [...idx]) {
      ...
      if (solved) { xorInto(words, solved); idx.delete(b) }
    }
